package com.hydroyura.prodms.warehouse.server.config.web;

import static com.hydroyura.prodms.warehouse.server.SharedConstants.LOG_MSG_GOT_REQUEST;
import static com.hydroyura.prodms.warehouse.server.SharedConstants.REQUEST_ATTR_UUID_KEY;
import static com.hydroyura.prodms.warehouse.server.SharedConstants.REQUEST_LOG_ID_HEADER_NAME;
import static com.hydroyura.prodms.warehouse.server.SharedConstants.REQUEST_TIMESTAMP_KEY;
import static com.hydroyura.prodms.warehouse.server.SharedConstants.REQUEST_URI_KEY;
